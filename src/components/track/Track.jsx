                ...
                <div className="flex flex-wrap -m-4 text-center">
                    ...
                    <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                        <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg">
                            ...
                            {/* <h2 className="title-font font-medium text-lg text-gray-900">Perfumes originales de Outlet</h2> */}
                            <p className="leading-relaxed text-sm">
                                Esto quiere decir que son los mismos que las perfumerías pero tienen fallas en su envase o vienen sin caja.
                            </p>
                        </div>
                    </div>
